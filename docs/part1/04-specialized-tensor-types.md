# 1.3.4 Specialized Tensor Types: Identity, Diagonal, Sparse & Triangular

### File: `45_specialized_tensors_part_a.mojo`
...
### Part 1.3.4A -- Identity Matrix Implementation
...
#### 1.3.4A.1 Identity Tensor Core Implementation
...
#### 1.3.4A.4 Performance Utilities
...
### Part 1.3.4B -- Diagonal Tensor Implementation (Standalone)
...
### Part 1.3.4B -- Diagonal Tensor Implementation
...
#### 1.3.4B.1 Diagonal Tensor Core Implementation
...
#### 1.3.4B.2 Multi-Diagonal Tensor Implementation
...
#### 1.3.4B.5 Performance Utilities
...
### Part 1.3.4C -- Sparse Tensor Implementation (Standalone)

```mojo

**File: `45_specialized_tensors_part_c.mojo`**
...
### Part 1.3.4C -- Sparse Tensor Implementation
...
#### 1.3.4C.1 Sparse Element Structure
...
#### 1.3.4C.2 COO Sparse Tensor Implementation
...
#### 1.3.4C.5 Performance Utilities
...
### Part 1.3.4D -- Triangular Tensor Implementation (Standalone)

```mojo

**File: `45_specialized_tensors_part_d.mojo`**
...
### Part 1.3.4D -- Triangular Tensor Implementation
...
#### 1.3.4D.1 Triangular Tensor Core Implementation
...
#### 1.3.4D.4 Performance Utilities
